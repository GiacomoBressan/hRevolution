        ...
        <div className="w-full h-[600px] bg-white flex">
            <div className="w-full bg-vibranium flex items-center">  
                <ul className="flex flex-col space-y-4 p-8 text-customGray text-2xl font-bold">
                    ...
                    <ListItem icon={<FaHandsHelping />} text="Prevenire e Gestiere: Il Contenzioso Aziendale" />
                    <ListItem icon={<FaMoneyBillTrendUp />} text="Retribuzione Strategica: Ottimizza il costo del Lavoro" />
                    <ListItem icon={<FaFaceSmileBeam />} text="Benessere in Azienda: Gestione del Team e Welfare Aziendale" />
                    <ListItem icon={<MdSavings />} text="Numeri Vincenti: Budget Aziendale e del Personale" />
                </ul>
            </div>
